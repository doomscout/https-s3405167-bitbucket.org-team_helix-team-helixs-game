...
public class HelpGUI : MonoBehaviour {
    ...
    void OnGUI(){
		...
		if (GameTools.Player != null) {
            GUI.Box(new Rect(100, 100, 100 + 10, 20), "" + GameTools.Player.stats.Health);
            GUI.Box(new Rect(100, 100, (float)GameTools.Player.stats.Health/(float)GameTools.Player.stats.Max_Health * 100.0f + 10, 20), "");
		}
